...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/visuals/visualsModule.js',
			'app/modules/visuals/visualsCtrl.js',
			'app/modules/visuals/visualsRoute.js',
			'app/modules/visuals/visualsService.js',
			'app/modules/visuals/visuals-test.js',
		],
